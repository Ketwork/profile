...
const eventCountdown = () => {
    ...
    subtitle.innerHTML = `<a href="https://londonclimbingcentres.co.uk/?page_id=424" id="subtitle">🧗International Womens Day Comp🥇 ${textDay}:${textHour}:${textMinute}:${textSecond}</a>`;
